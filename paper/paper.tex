...
An introduction to generating functions can be found in \cite{wilf1994generatingfunctionology} (this version of the book is referenced by Watts in his paper below).
