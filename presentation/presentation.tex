...
\begin{frame}
    ...
    \begin{itemize}
        \fitem Culture: \textbf{Twilight}
        \fitem Technology Adoption: \textbf{WhatsApp}
        \fitem Social Dynamics: \textbf{Political Coups}
        \fitem Information Propagation: \textbf{Job Interviews}
    \end{itemize}
    \vfill
\end{frame}
